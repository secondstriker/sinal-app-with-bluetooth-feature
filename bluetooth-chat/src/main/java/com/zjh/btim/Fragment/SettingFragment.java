...
public class SettingFragment extends Fragment implements View.OnClickListener {
    ...
    private static final String VALUE_OPEN = "Bluetooth has been opened\nclick to close";
    private static final String VALUE_CLOSE = "Bluetooth is not open\nclick to open";
