...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BLUE_TOOTH_READ:
                    ...
                    list.add(new ChatInfo(ChatInfo.TAG_LEFT, "", readMessage));
                    recyclerChatAdapter.notifyDataSetChanged();
                    recyclerView.smoothScrollToPosition(list.size());
                    dbManager.add(new ChatRecord(deviceMac, ChatInfo.TAG_LEFT, "", readMessage));
                    break;
                case BLUE_TOOTH_WRAITE:
                    String writeMessage = (String) msg.obj;
                    Log.i("zjh聊天", "我" + ":" + writeMessage);
                    list.add(new ChatInfo(ChatInfo.TAG_RIGHT, "", writeMessage));
                    recyclerChatAdapter.notifyDataSetChanged();
                    recyclerView.smoothScrollToPosition(list.size());
                    dbManager.add(new ChatRecord(deviceMac, ChatInfo.TAG_RIGHT, "", writeMessage));
                    break;
                ...
                case BLUE_TOOTH_READ_FILE:
                    ...
                    list.add(new ChatInfo(ChatInfo.TAG_FILE_LEFT, "", msg.obj + ""));
                    recyclerChatAdapter.notifyDataSetChanged();
                    recyclerView.smoothScrollToPosition(list.size());
                    dbManager.add(new ChatRecord(deviceMac, ChatInfo.TAG_FILE_LEFT, "", msg.obj + ""));
                    break;
                case BLUE_TOOTH_WRAITE_FILE:
                    Log.i("zjh蓝牙文件传输", "文件发送完成");
                    dialog.dismiss();
                    list.add(new ChatInfo(ChatInfo.TAG_FILE_RIGHT, "", msg.obj + ""));
                    recyclerChatAdapter.notifyDataSetChanged();
                    recyclerView.smoothScrollToPosition(list.size());
                    dbManager.add(new ChatRecord(deviceMac, ChatInfo.TAG_FILE_RIGHT, "", msg.obj + ""));
                    break;
                case UPDATE_DATA:
                    recyclerChatAdapter.notifyDataSetChanged();
                    recyclerView.smoothScrollToPosition(list.size());
            ...
            case FILE_SELECT_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    if (path != null) {
                        ...
                        ad.setMessage("You are sure you want to send" + path + "?");
                        ad.setTitle("Prompt");
    ...
    private void exit() {
        ...
        ad.setNeutralButton("Minimization", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
